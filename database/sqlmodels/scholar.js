...
module.exports = {
  insert: function (req, res) {
    ...
    var sql =
      "INSERT INTO schol(sname,authority,aname,spass,cutoff,state,applbranchtotal,applbranch,incomelimit,benefit,link)  VALUES(" +
      FieldOne +
      ",'" +
      FieldTwo +
      "','" +
  ...
  filterscholar: function (req, res) {
    ...
    if (authority) {
      ...
      if (region == "India") {
        sql =
          "SELECT id,sname,authority FROM schol WHERE category='" +
          category +
          "' AND authority IN " +
          incat +
          " AND spass='" +
  ...
  getall: function (req, res) {
    var sql =
      "SELECT * FROM answers a,question q WHERE a.sid=q.sid AND a.qid=q.qid";
    console.log(sql);
    con.query(sql, function (err, result) {
      if (err) throw err;
      console.log(result);
